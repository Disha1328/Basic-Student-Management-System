...
usn=['1CR19IS101','1CR19IS102','1CR19IS103','1CR19IS104','1CR19IS105']
...
def fetch_data():
    ...
    # return ([rows1,rows2,rows3,rows4,rows5])
#create_physics_table(names,usn)
#create_chemistry_table(names,usn)
#create_maths_table(names,usn)
#create_english_table(names,usn)
#create_computer_table(names,usn)
